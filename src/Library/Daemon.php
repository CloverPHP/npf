...
class Daemon
{
     ...
     * @param bool $force kill -9 or kill
     * @return bool
     * @throws Exception
     */
...
//only use Npf\in singleton model
        if (!$this->_singleton)
            throw new Exception("'stop' only use Npf\in singleton model.");
    ...
    public function start()
    {
        ...
        //close file handle STDIN STDOUT STDERR
        //notic!!!This makes no use Npf\in PHP4 and some early version of PHP5
